"""
Django settings for cp_ws_project project.
...
ROOT_URLCONF = 'cp_ws_project.urls'
...
WSGI_APPLICATION = 'cp_ws_project.wsgi.application'
ASGI_APPLICATION = 'cp_ws_project.asgi.application'
